...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentsChatChatlistChatlistComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ChatlistComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 3,
      consts: [[3, "ngClass"], [1, "header"], ["type", "text", 3, "ngModel", "ngModelChange"], [3, "click"], [1, "body"], [4, "ngFor", "ngForOf"], [1, "buttons"], [1, "chat", 3, "click"]],
      template: function ChatlistComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ChatlistComponent_Template_button_click_8_listener() {
            return ctx.chatService.refreshChats();
          });
